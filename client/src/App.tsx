...
type Tab = 'dashboard' | 'shared' | 'settings';
...
const IconShared = () => (<svg className={sIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>);
...
const NAV: { key: Tab; label: string; icon: () => JSX.Element }[] = [
  ...
  { key: 'shared', label: 'Shared', icon: IconShared },
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="mx-auto w-full max-w-5xl px-6 py-8">{tab === 'dashboard' ? <Dashboard /> : tab === 'shared' ? <Shared /> : <Settings />}</main>
      </div>
    </div>
  );
}
